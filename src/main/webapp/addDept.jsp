...
<body>
	<div id="p" class="easyui-panel" title="当前位置：部门管理 > 添加部门"
		style="width: full; height: full; padding: 10px; background: #fafafa;">
		<form id="form">
			<table>
				<tr>
					<td>部门名称:</td>
					<td><input name="deptName" class="easyui-textbox"
				...
				<tr>
					<td align="center" colspan="2"><a id="btn_add"
						...
						onclick="add()">添加</a> <a id="btn_clear" class="easyui-linkbutton"
						data-options="iconCls:'icon-clear'" style="margin-left: 50px"
						onclick="window.location.href = 'addDept.jsp'">清空</a></td>
				</tr>
			</table>
		</form>
